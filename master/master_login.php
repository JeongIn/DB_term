...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql = "SELECT * FROM employee WHERE employee_id='$ID' and employee_pw='$PW'";
    $result = $db->query($sql); 
    ...
    if($row === 1)
    {
        ...
        header("location: master_choose.php");
    }else{
...
<html>
    ...
    <body>
	    ...
	    <form action="" method="post">
	        <h2 class="form-signin-heading">직원 로그인하세요</h2>
            ...
            <a href="./new_master.php" class='gaip'>회원가입</a>
	    </form>
